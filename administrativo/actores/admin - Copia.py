...
class DirectoriosAdmin(admin.ModelAdmin):
      ...
      list_filter = ('estatu','areasaccion','estado','fund',)
      search_fields = ('documentoidentidad','nombre', 'apellido','correo')
      list_display = ('documentoidentidad','nombre', 'apellido','estatu')
      fieldsets = [
            ('Datos Basicos',               {'fields': ['tipodoci','documentoidentidad','nombre','apellido','correo','telefono1','telefono2','fax','movil','listacorreos','ocupacion']}),
...
class ActoresAdmin(AutocompleteModelAdmin):
      inlines = [DocAsocActAdmin,RedesAdmin,ColaboradorespersonasAdmin]
      ...
      def formfield_for_foreignkey(self, db_field, request, **kwargs):
          ...
          if db_field.name == "categoriact":
             kwargs["queryset"] = Categorias.objects.filter(seccione__titulo='Actores')
...
#=================================================================================================
class BancoaudiovisualsAdmin(admin.ModelAdmin):
      ...
      list_display = ('id','imagen','directorio','tipo','estatu','seccion')
      list_display_links = ('id','directorio','tipo','estatu','seccion')
      def id(self, instance):
          return instance.id
      search_fields = ('directorio','lugar','descripcion','observaciones')
