	...
	function selectItem(li) {
		...
		if (options.onItemSelect){
			...
			if (autocomplete_mode == "ForeignKey"){
				...
				document.getElementById('valorForen').value=li.selectValue;
				django.jQuery("#foreingkey_id",options.lookup_obj.parent()).val( sValue );
			}else if(autocomplete_mode == "ManyToMany"){
				//if( li == null ) return
...
django.jQuery.fn.autocomplete = function(url, options, data) {
	...
	options.url = lookup_obj.attr('base_url') + options.url
