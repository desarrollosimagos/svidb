...
}if(!this.buttons){d=h.navButtons;var f=false;this.buttons=a('<ul class="pager"/>');this.buttons.addClass("bwizard-buttons");if(c!=""){this.backBtn=a("<li class='previous'><a href='#' onclick=\"alert('Recuerde guardar cada seccion antes de continuar.ß')\">"+c+"</a></li>").appendTo(this.buttons).bind({click:function(){e.back();
return false;}}).attr("role","button");var f=true;}if(g!=""){this.nextBtn=a("<li class='next'><a href='#' onclick=\"alert('Recuerde guardar cada seccion antes de continuar.')\">"+g+"</a>").appendTo(this.buttons).bind({click:function(){e.next();
