...
<html lang="en">
    ...
    <body class="animated fadeIn">
        ...
        <header class="header">
            ...
            <div class="header-profile">
                <div class="profile-nav">
                    ...
                    <a href="form-wizard.php#" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="fa fa-angle-down"></span>
                    </a>
                    <ul class="dropdown-menu animated flipInX pull-right" role="menu">
                        <li><a href="form-wizard.php#"><i class="fa fa-user"></i> Profile</a></li>
                        <li><a href="form-wizard.php#"><i class="fa fa-envelope"></i> Inbox</a></li>
                        <li><a href="form-wizard.php#"><i class="fa fa-tasks"></i> Tasks</a></li>
                        <li class="divider"></li>
                        <li><a href="form-wizard.php#"><i class="fa fa-sign-out"></i> Log Out</a></li>
                    </ul>
                </div>
            ...
            <ul class="hidden-xs header-menu pull-right">
                <li>
                    <a href="form-wizard.php#" title="View site">
                        <i class="header-menu-icon icon-only fa fa-rocket"></i>
                    </a>
                </li><!-- /header-menu-item -->
                <li>
                    <a href="form-wizard.php#" title="Notifications" class="dropdown-toggle" data-toggle="dropdown" role="button">
                    ...
                    <ul class="dropdown-menu dropdown-extend animated fadeInDown pull-right" role="menu">
                        ...
                        <li class="notif-minimal" data-toggle="niceScroll" data-scroll-cursorcolor="#ecf0f1">
                            <a class="notif-item" href="form-wizard.php#">
                        ...
                        <li class="dropdown-footer bg-cloud">
                            <a class="view-all" tabindex="-1" href="form-wizard.php#">
                ...
                <li>
                    <a href="form-wizard.php#" title="Inboxs" class="dropdown-toggle" data-toggle="dropdown" role="button">
                ...
                <li>
                    <a href="form-wizard.php#" title="Tasks" class="dropdown-toggle" data-toggle="dropdown" role="button">
            ...
            <div class="content">
                <div class="content-header">
                    <div class="content-header-extra">
                        <a class="item-ch-extra" href="form-wizard.php#">
                ...
                <div class="content-control">
                    ...
                    <ul class="control-nav pull-right">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu animated flipInX pull-right">
                                <li><a href="form-wizard.php#">Some Action</a></li>
                                <li><a href="form-wizard.php#">Other Action</a></li>
                                <li class="divider"></li>
                                <li><a href="form-wizard.php#">Something Else</a></li>
                            </ul>
                        </li>
                        <li class="divider"></li>
                        <li rel="popover-left" data-context="inverse" data-trigger="hover" data-content="Click me to toggle Chat box!">
                            <a data-toggle="side-right" href="form-wizard.php#">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="form-wizard.php#">Library</a></li>
                ...
                <div class="content-body">
                    ...
                    </form><!-- /form wizard -->                </div><!--/content-body -->
            </div><!--/content -->
            ...
            <div class="module" data-toggle="niceScroll">
                <div class="chat-contact">
                    <h3 class="contact-heading">
                        <div class="btn-group pull-right">
                            <a href="form-wizard.php#" data-toggle="side-right">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li class="active"><a href="form-wizard.php#"><i class="fa fa-circle text-primary"></i> Online</a></li>
                                <li><a href="form-wizard.php#"><i class="fa fa-circle text-danger"></i> Offline</a></li>
                                <li><a href="form-wizard.php#"><i class="fa fa-circle text-warning"></i> Idle</a></li>
                                <li class="divider"></li>
                                <li><a href="form-wizard.php#"><i class="fa fa-circle text-midnight"></i> Disable</a></li>
                            </ul>
                        </div>
                    </h3><!-- /contact-heading -->
                    ...
                    <div class="contact-body">
                        <ul class="contacts-list">
                            ...
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> Phillip Morrison</a></li>
                            <li class="offline"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="offline" rel="tooltip-bottom"></i> Samuel Porter</a></li>
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> Kathy Reynolds</a></li>
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> Aaron James</a></li>
                            <li class="idle"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="idle" rel="tooltip-bottom"></i> Teresa May</a></li>

                            <li class="separate">Teams</li>
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> John Doe</a></li>
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> Iin Triasneni</a></li>
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> Mahatma</a></li>
                            <li class="offline"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="offline" rel="tooltip-bottom"></i> Lawrence Ramirez</a></li>
                            <li class="offline"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="offline" rel="tooltip-bottom"></i> Samantha Jenkins</a></li>
                            <li class="disable"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="disable" rel="tooltip-bottom"></i> Sarah Payne</a></li>
                            <li class="offline"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="offline" rel="tooltip-bottom"></i> Justin Perry</a></li>

                            <li class="separate">Clients</li>
                            <li class="idle"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="idle" rel="tooltip-bottom"></i> Rebecca Vargas</a></li>
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> Sean Carpenter</a></li>
                            <li class="idle"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="idle" rel="tooltip-bottom"></i> Arthur Pearson</a></li>
                            <li class="offline"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="offline" rel="tooltip-bottom"></i> Julie Jimenez</a></li>
                            <li class="idle"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="idle" rel="tooltip-bottom"></i> Sandra Ramirez</a></li>
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> Nicholas Cole</a></li>
                            <li class="idle"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="idle" rel="tooltip-bottom"></i> Madison Hall</a></li>
                            <li class="offline"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="offline" rel="tooltip-bottom"></i> Alan Shaw</a></li>
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> Randy Mills</a></li>

                            <li class="separate">All</li>
                            <li class="disable"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="disable" rel="tooltip-bottom"></i> Kenneth Soto</a></li>
                            <li class="disable"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="disable" rel="tooltip-bottom"></i> Harold James</a></li>
                            <li class="online"><a href="form-wizard.php#"><i class="fa fa-circle-o" title="online" rel="tooltip-bottom"></i> Paul Greene</a></li>
                        </ul><!-- /contacts-list -->
                    </div><!-- /contact-body -->
                </div><!-- /chat-contact -->
                ...
                <div class="chatbox">
                    <h3 class="chatbox-heading">
                        <a data-toggle="chatbox-close" href="form-wizard.php#" class="pull-right text-sm text-silver"><i class="fa fa-times"></i></a>
        ...
        <!-- section footer -->
        <a rel="to-top" href="form-wizard.php#top"><i class="fa fa-arrow-up"></i></a>
        <footer>
