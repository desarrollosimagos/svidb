				...
				<div class="signin-wrapper">
								...
								<div id="carousel-example" class="carousel slide" data-ride="carousel">
							      	...
							      	<div class="carousel-inner">
								        <div class="item active">
								          	<img src="images/dummy/7b14b475.img7.png" alt="Slide image">
								        </div>
								        <div class="item">
								          	<img src="images/dummy/1166769f.img11.png" alt="Slide image">
								        </div>
								        <div class="item">
								          	<img src="images/dummy/2590d12d.img2.png" alt="Slide image">
								        </div>
								        <div class="item">
								          	<img src="images/dummy/4e81cd8d.img6.png" alt="Slide image">
								        </div>
								        <div class="item">
								          	<img src="images/dummy/3e4d8287.img3.png" alt="Slide image">
								        </div>
							      	</div>
							      	<a class="left carousel-control" href="page-signin.php#carousel-example" data-slide="prev">
							        	<span class="glyphicon glyphicon-chevron-left"></span>
							      	</a>
							      	<a class="right carousel-control" href="page-signin.php#carousel-example" data-slide="next">
								...
								<div class="signin">
									<div class="signin-brand">
										<a href="page-signin.php">
											<img class="lazy" data-original="images/dummy/48f4bb8e.Stilearn-logo-primary.png" alt="Sign In">
										</a>
									</div><!--/signin-brand-->

									<form action="index.php" method="POST" data-validate="form" role="form" id="signin-form">
										<p><small>Stilearn Admin account. <a href="page-signin.php#">Learn more?</a></small></p>
										...
										<p>
											<small>
												<a href="page-signin.php#modalRecover" data-toggle="modal">Can't Access your Account?</a><br>
												<a href="page-signin.php#" class="hidden-sm">Sign in with another account?</a>
											</small>
										</p>
										<p class="hidden-sm">
											<a href="page-signin.php#" rel="tooltip" title="Signin with Twitter account" class="btn btn-sm btn-info"><span class="fa fa-twitter"></span></a>
											<a href="page-signin.php#" rel="tooltip" title="Signin with Google account" class="btn btn-sm btn-danger"><span class="fa fa-google-plus"></span></a>
											<a href="page-signin.php#" rel="tooltip" title="Signin with Github account" class="btn btn-sm btn-cloud"><span class="fa fa-github"></span></a>
										</p>

										<p class="margin-top"><small>Don't have a account? <a data-toggle="tab" href="page-signin.php#signup"><strong>Creata an Account</strong></a></small></p>
									</form><!--/#signin-form-->
								</div><!--/signin-->
					...
					<div class="signin-footer">
						<ul class="list-inline pull-right">
							<li><a href="page-signin.php#">Knowledge base</a></li>
						</ul>
						<ul class="list-inline">
							<li>&copy; 2014 Stilearning</li>
							<li><a href="page-signin.php#">Terms of Use</a></li>
							<li><a href="page-signin.php#">Privacy Policy</a></li>
						</ul>
					</div>
